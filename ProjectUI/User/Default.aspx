<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ProjectUI.User.Default" %>
                    ...
                    <div class="col-lg-4 col-md-6 pb-1">
                        <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px">
                            <a href="Shop.aspx" class="cat-img position-relative overflow-hidden mb-3">
                                <img height="40" class="img-fluid" src="<%# ProjectUI.Util.getImageUrl(Eval("CategoryImageUrl")) %>" />
            ...
            <div class="col-md-6 pb-4">
                <div
                    ...
                    <div class="position-relative" style="z-index: 1">
                        <h5 class="text-uppercase text-primary mb-3">20% off the all order
                        </h5>
