<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SliderUserControl.ascx.cs" Inherits="ProjectUI.User.SliderUserControl" %>
                            ...
                            <div class="carousel-item active" style="height: 410px">
                                ...
                                <div
                                    ...
                                    <div class="p-3" style="max-width: 700px">
                                        <h4
                                            class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order
                    </h4>
